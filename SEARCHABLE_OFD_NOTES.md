...
記錄如何生成可搜索的 OFD 文件（Searchable OFD），包含透明文字層的技術實現細節。本文檔同時涵蓋 PDF 與 OFD 兩種格式的產生方法。
...
> 如果實際 DPI 不是 72，需調整公式：`double mm = pixel * 25.4 / actualDPI;`
...
- **JSON 配置指南**: [JSON-CONFIG-GUIDE.md](JSON-CONFIG-GUIDE.md)
- **原始碼**:
