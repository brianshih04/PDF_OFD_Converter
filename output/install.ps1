...
$CertName = "CN=JPEG2PDF-OFD OCR CLI"
$FSName = "jpeg2pdf-ofd-cli"
$PackageName = "Jpeg2pdfOfdCli"
$Site = "https://brianshih04.github.io/jpeg2pdf-ofd-conveyor"
...
start "shell:appsFolder\Jpeg2pdfOfdCli_gq9f15vnqsnew!Jpeg2pdfOfdCli"
